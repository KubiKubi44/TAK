                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
                    ...
                    <div className="text-center md:text-left space-y-6">
                        ...
                        <ul className="space-y-3 font-mono text-gray-400">
                            ...
                            <li><a href="https://www.facebook.com/profile.php?id=61587909838380" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:shadow-[0_0_10px_rgba(255,255,255,0.5)] transition-all">Facebook</a></li>
                            <li><a href="https://www.linkedin.com/company/itakk-cz/" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:shadow-[0_0_10px_rgba(255,255,255,0.5)] transition-all">LinkedIn</a></li>
                        </ul>
                    </div>
